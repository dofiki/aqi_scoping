...
export function Navbar() {
  ...
  return (
    <>
      <div
        className="flex justify-around items-center h-15 text-gray
                 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm 
                 bg-opacity-20 border border-t-0 border-l-0 border-r-0"
      >
    ...
    `}
      ...
      <div
        className={`absolute sm:hidden h-55 w-full bg-black z-50
