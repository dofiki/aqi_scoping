...
import { aqiSearchService, aqiTrackService, trackedAqiService } from "../services/aqi.service";
...
export const trackedAqi = async(req:Request, res:Response): Promise<void> =>{
    try{
        const userId = req.user?.id as string;
